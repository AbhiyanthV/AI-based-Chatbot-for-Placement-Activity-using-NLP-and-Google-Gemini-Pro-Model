...
For example 3, "which comapany hired most of cse students and in which year and what was the pay and eligigbilty critria of that company?" and {data}= [(2022, 'Cognizant', 61.0, '4 & 6.75', '\xa0\xa0\xa0Aggregate of 6 .75 CGPA and above,Without Backlogs')],
Cognizant hired the most CSE students in 2022 and it hired 61 students , with a salary package of 4 & 6.75 lakhs per annum. The eligibility criteria for this job was an aggregate of 6.75 CGPA and above, with no backlogs.
Adapt this prompt to handle various types of answers for the question asked , including cases where the answer may be a single item or a list of many items, and produce appropriate responses.
"""
